...
import operator
import ast
from app.config import SAMPLE_RECIPE_PATH3_MAC, APP_TITLE
import numpy as np
import re
 

print(f"SAMPLE_RECIPE_PATH3_MAC: {SAMPLE_RECIPE_PATH3_MAC}")  # Very important for debugging

df = pd.read_parquet(SAMPLE_RECIPE_PATH3_MAC)
st.write(APP_TITLE)

st.logo("/Users/bianp/Desktop/logo_appli.png", size="medium")
