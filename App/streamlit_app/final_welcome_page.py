...
html_file_path = "pages/wp_no_images.html"  # Or a full path like "C:/path/to/your/file.html"
...
image1 = st.image("search_avocado.jpg")
image2 = st.image("results_avocado_search.jpg")
